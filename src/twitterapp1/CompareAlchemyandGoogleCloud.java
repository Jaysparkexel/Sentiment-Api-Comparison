 ...
 * @author Jay
 */
public class CompareAlchemyandGoogleCloud {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException  {
        FileReader fr1 = new FileReader("C:/Users/Jay/Desktop/Projects/Documentation/Samples/TweetsSampleAlchemy.txt");
        ...
        File fout = new File("C:/Users/Jay/Desktop/Projects/Documentation/Samples/compareAlchemyandGoogleCloud.txt");
	FileOutputStream fos = new FileOutputStream(fout);
        ...
        while(((currentLine1 = br1.readLine()) != null) && ((currentLine2 = br2.readLine()) != null)){
            ...
            if(fLine1.contains(": ") && sLine1.contains(": ")){
                ...
                if(!tweetSenti1.equals("Not Supported")){
