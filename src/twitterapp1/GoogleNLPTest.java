 ...
 * @author Jay
 */
public class GoogleNLPTest {
     static GoogleCloudNaturalLanguageApiCheck googleApiCheck = new GoogleCloudNaturalLanguageApiCheck();
 ...
 //   static float score = 0.0f;
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException, ParseException {
        ...
        File fout = new File("C:/Users/Jay/Desktop/Projects/Documentation/Samples/TweetsSampleGoogleCloudNLP35final.txt");
        ...
        while ((currentLine = br.readLine()) != null){
            ...
            if(Line3 != null){
                ...
                if(Line3.contains(" - ")){
                   ...
                   // try {
                       sentiTypeFull = googleApiCheck.checkPositivity(tweet);
                  //  }
                  //  catch(com.ibm.watson.developer_cloud.service.exception.BadRequestException e){
                  //     sentiType = "Not Supported";
                  //  }
                       sentiType = (sentiTypeFull.split(" : "))[0];
//                       try{
//                       score = Float.parseFloat((sentiTypeFull.split(" : "))[1]);
//                       } 
//                       catch (Exception e){
//                           score = 3.0f;
//                       }
